  ...
  return (
    <div className="flex gap-4 flex-wrap lg:flex-nowrap mt-12">
      <div className="card-shadow p-8">
        <div
          href="#"
          className="p-10 relative experience hover:text-white rounded-xl"
        >
          ...
          {/* yellow blob */}
          <svg
            className="yellow-blog absolute bottom-0 right-0 hidden"
            width="197"
            height="237"
            viewBox="0 0 197 237"
            fill="none"
          ...
          >
            <g opacity="0.3" filter="url(#filter0_f_181_337)">
              <ellipse
                cx="149.516"
                cy="153"
                rx="58.9355"
            ...
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="45"
                  result="effect1_foregroundBlur_181_337"
                />
              </filter>
            </defs>
          </svg>
